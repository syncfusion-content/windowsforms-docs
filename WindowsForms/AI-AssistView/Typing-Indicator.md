---
layout: post
title: Typing Indicator in Windows Forms AIAssistView | Syncfusion
description: Display a typing indicator while the AI processes or generates a response in the Syncfusion Windows Forms AIAssistView.
platform: windowsforms
control: SfAIAssistView
documentation: ug
---

# Typing Indicator in Windows Forms AIAssistView
