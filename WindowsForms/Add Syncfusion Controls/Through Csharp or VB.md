...
The following steps will helps to add a required Essential WF Control (For example: DockingManager) through C# / VB Code
...
3. Create instance of Docking Manager.
