...
Callout is a data label text which is used to dragging and customizing the text dynamically. It allows you to drag and drop the data label in any place of chart area and provides support to edit callout properties by double clicking on the callout label.
