...
# About Syncfusion® WinForms CheckBox Control
...
* **Appearance and Behavior Settings** - The focus rectangle can be made visible or hidden. The height of the WinForms CheckBox can be automatically calculated. Its mode can be set to the `ReadOnlyMode`. The [Tristate](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Tools.CheckBoxAdv.html#Syncfusion_Windows_Forms_Tools_CheckBoxAdv_Tristate) property can be used to access the indeterminate state through a single click.

* **Alignment Settings** - The text and check box of the WinForms CheckBox control can be aligned to any desired location by users.

* **Background Settings** - WinForms CheckBox can be created with custom gradient backgrounds.
...
* **Data binding** - You can bind the WinForms CheckBox to a datasource such as an SQL database.
