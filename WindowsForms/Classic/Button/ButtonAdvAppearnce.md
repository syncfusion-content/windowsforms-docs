...
N> You can also specify your own image for the ButtonAdv using Image property and this will effect only when ButtonType is set to Normal. See [Image Settings](https://help.syncfusion.com/windowsforms/classic/button/imagesettings) to know more.
...
[Button Types](https://help.syncfusion.com/windowsforms/classic/button/buttonadvappearnce)
...
[Button Types](#button-types), [Image Settings](https://help.syncfusion.com/windowsforms/classic/button/imagesettings)
