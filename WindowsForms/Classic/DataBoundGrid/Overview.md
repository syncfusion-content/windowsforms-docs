...
description: Learn about Overview support in Syncfusion Windows Forms GridDataBoundGrid(Classic) control and more details.
platform: windowsforms
control: GridDataBoundGrid
documentation: ug
---

# Overview in Windows Forms GridDataBoundGrid(Classic)
