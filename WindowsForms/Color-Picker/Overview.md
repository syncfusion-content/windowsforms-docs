...
The Essential<sup>®</sup> Tools WinForms color picker allows .NET developers to provide Microsoft Word 2007 ColorCells for selecting colors in their applications. It comprises of a panel displaying themed colors and standard colors. It also comes with a More Colors option, in a color dialog, displaying more sub colors for the base colors in the control. 
