...
The `SfComboBox` allows you to clear the selected item using the clear button. Only when the selection or editing takes place inside the SfComboBox will the clear button be visible.

The `ShowClearButton` property controls whether or not the clear button is available. It is applicable for both DropDownStyle.
...
![ClearButton image](Appearance_images/Appearance_img11.png)

### Customizing clear button appearance
...
![ClearButton with appearance](Appearance_images/Appearance_img12.png)
