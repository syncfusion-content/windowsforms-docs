...
![WinForms SfComboBox Choose the datasource type through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-datasource-type-through-the-visual-studio.jpeg)

3) Select **Database** on the **Choose a Data Source Type** page, and then select **Next**.

![WinForms SfComboBox Choose the datasource model through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-datasource-model-through-the-visual-studio.jpeg)
...
![WinForms SfComboBox Choose the data connetion through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-data-connetion-through-the-visual-studio.jpeg)
...
![WinForms SfComboBox Choose the data provider through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-data-provider-through-the-visual-studio.jpeg)
...
![WinForms SfComboBox Choose the data base objects through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-database-objects-through-the-visual-studio.jpg)
...
![WinForms SfComboBox Choose the data source through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-data-source-through-the-visual-studio.jpg)
...
![WinForms SfComboBox Choose the display member through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-display-member-through-the-visual-studio.jpg)

![WinForms SfComboBox Choose the value member through the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-value-member-through-the-visual-studio.jpg)
...
![WinForms SfComboBox Displayed the items using data source binding through the visual studio](DataBinding_images/WinForms-SfComboBox-Items-displayed-using-data-source-binding-through-the-visual-studio.jpg)
...
![WinForms SfComboBox Choose the data  model from LINQ to SQL from the visual studio](DataBinding_images/WinForms-SfComboBox-Choose-the-data-model-from-LINQ-to-SQL-from-the-visual-studio.jpeg)

4) Once the **Northwind.dbml** is added in the project, then the design view is opened.

![WinForms SfComboBox Connect the database through the visual studio](DataBinding_images/WinForms-SfComboBox-Connect-the-database-through-the-visual-studio.jpeg)
...
![WinForms SfComboBox Add connection to database through the visual studio](DataBinding_images/WinForms-SfComboBox-Add-connection-to-database-through-the-visual-studio.jpeg)
...
![WinForms SfComboBox Change the database through the visual studio](DataBinding_images/WinForms-SfComboBox-Change-the-database-through-the-visual-studio.jpeg)

8) Select the Database file name and click on **Test Connection** to check the connection with the database.

![WinForms SfComboBox Test connection with the database](DataBinding_images/WinForms-SfComboBox-Test-connection-with-the-database.jpeg)
...
![WinForms SfComboBox Items displayed using data source binding through the visual studio](DataBinding_images/WinForms-SfComboBox-Items-displayed-using-data-source-binding-through-the-visual-studio.jpg)
