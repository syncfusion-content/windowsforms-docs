---
layout: post
title: Data Binding in Windows Forms ComboBox | Syncfusion®
description: Data binding in Windows Forms ComboBox enables connecting to various data sources using display and value members for efficient data presentation.
platform: windowsforms
control: ComboBox
documentation: ug
---

# Data Binding in Windows Forms ComboBox
...
* `DisplayMember`: To display the underlying datasource for ComboBox.
...
The ComboBox control supports to bind data from Microsoft Access database. This section describes about how to bind the data from Microsoft Access database to [SfComboBox](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfComboBox.html) control.
...
![WinForms ComboBox Datasource type choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-Datasource-type-choosing-through-the-visual-studio.jpeg)

3) Select **Database** on the **Choose a Data Source Type** page, and then select **Next**.

![WinForms ComboBox Datasource model choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-Datasource-model-choosing-through-the-visual-studio.jpeg)
...
![WinForms ComboBox data connection choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-data-connection-choosing-through-the-visual-studio.jpeg)
...
![WinForms ComboBox data provider choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-data-provider-choosing-through-the-visual-studio.jpeg)
...
![WinForms ComboBox data base objects choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-data-base-objects-choosing-through-the-visual-studio.jpg)
...
![WinForms ComboBox Datasource choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-Datasource-choosing-through-the-visual-studio.jpg)
...
![WinForms ComboBox display member choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-display-member-choosing-through-the-visual-studio.jpg)

![WinForms ComboBox value member choosing through the visual studio](DataBinding_images/WinForms-SfComboBox-value-member-choosing-through-the-visual-studio.jpg)
...
![WinForms ComboBox items displayed using Datasource binding through the visual studio](DataBinding_images/WinForms-SfComboBox-items-displayed-using-Datasource-binding-through-the-visual-studio.jpg)
...
![WinForms ComboBox data model choosing from LINQ to SQL from the visual studio](DataBinding_images/WinForms-SfComboBox-data-model-choosing-from-LINQ-to-SQL-from-the-visual-studio.jpeg)

4) Once the **Northwind.dbml** is added in the project, then the design view is opened.

![WinForms ComboBox database connection through the visual studio](DataBinding_images/WinForms-SfComboBox-database-connection-through-the-visual-studio.jpeg)
...
![WinForms ComboBox database connection adding through the visual studio](DataBinding_images/WinForms-SfComboBox-database-connection-adding-through-the-visual-studio.jpeg)
...
![WinForms ComboBox database changing through the visual studio](DataBinding_images/WinForms-SfComboBox-database-changing-through-the-visual-studio.jpeg)

8) Select the Database file name and click on **Test Connection** to check the connection with the database.

![WinForms ComboBox connection test with the database](DataBinding_images/WinForms-SfComboBox-connection-test-with-the-database.jpeg)

9) Once the connection is succeeded, click **OK** button to add database in the server explorer.

![WinForms ComboBox connected databases in the projects](DataBinding_images/WinForms-SfComboBox-connected-databases-in-the-projects.jpg)
...
![WinForms ComboBox Choose the value member through the visual studio](DataBinding_images/WinForms-SfComboBox-value-member-choosing-through-the-visual-studio.jpg)
...
![WinForms ComboBox Items displayed using data source binding through the visual studio](DataBinding_images/WinForms-SfComboBox-items-displayed-using-Datasource-binding-through-the-visual-studio.jpg)
