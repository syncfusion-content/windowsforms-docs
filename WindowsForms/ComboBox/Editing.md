---
layout: post
title: Editing in Windows Forms ComboBox | Syncfusion®
description: Editing in Windows Forms ComboBox enables users to edit or restrict input in the editor area using editable and non-editable dropdown modes.
