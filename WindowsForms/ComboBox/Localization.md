...
2. Add the default resource file of the SfListView into Resources folder. You can download the `Syncfusion.   SfListView.WinForms.resx` [here](https://s3.amazonaws.com/files2.syncfusion.com/dtsupport/directtrac/general/ze/ResourceFile1283641291.zip).
...
The default resource file can be edited by adding it to the Resources folder of the application where ComboBox reads the static texts here. The default resource file can be downloaded [here](https://s3.amazonaws.com/files2.syncfusion.com/dtsupport/directtrac/general/ze/ResourceFile1283641291.zip).
