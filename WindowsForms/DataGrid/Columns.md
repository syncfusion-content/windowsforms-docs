...
Data Grid provides support for creating columns automatically or manually. Below sections explains both the ways, 
Data Grid provides support for generating
...
The type of column adding to Data Grid can be changed by setting the instance of column that has to be added in [AutoGeneratingColumn](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.DataGrid.SfDataGrid.html#Syncfusion_WinForms_DataGrid_SfDataGrid_AutoGeneratingColumn) event.
...
Data Grid allows to resize the columns like in excel by resizing column header. 
...
{% endhighlight %}
{% endtabs %}
![ProductName column is hidden](Columns_images/HiddenColumn.png)
