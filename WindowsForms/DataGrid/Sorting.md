...
[Windows Forms DataGrid](https://www.syncfusion.com/winforms-ui-controls/datagrid) allows to sort the data against one or more columns either in ascending or descending order. When sorting is applied, the rows are rearranged based on sort criteria.
