---
layout: post
title: How to change the LineConnector color when activating the LineTool in Windows Forms Diagram | Syncfusion®
...
# How to change the LineConnector color when activating the LineTool in Windows Forms Diagram
