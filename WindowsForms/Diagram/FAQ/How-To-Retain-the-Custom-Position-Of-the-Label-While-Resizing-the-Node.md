---
layout: post
title: How to retain a label position while resizing a node in Windows Forms Diagram | Syncfusion®
...
# How to retain a label position while resizing a node in Windows Forms Diagram
