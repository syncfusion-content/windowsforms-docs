---
layout: post
title: How to fill shapes drawn using the Pencil Tool in Windows Forms Diagram | Syncfusion®
...
# How to fill shapes drawn using the Pencil Tool in Windows Forms Diagram
