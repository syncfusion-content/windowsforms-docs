...
Gets/sets the maximum number of simulation cycles. Higher values yield more stable layouts but take longer to compute.</td></tr>
<tr>
<td>
RepulsionStrength</td><td>
Gets/sets the magnitude of the repulsive force between nodes. Higher values produce more separation and help avoid overlap.</td></tr>
<tr>
<td>
AttractionStrength</td><td>
Gets/sets the spring factor pulling connected nodes together (0..1 typical). Higher values create tighter clusters.</td></tr>
</table>
...
Tune `MaximumIteration`, `RepulsionStrength`, and `AttractionStrength` to achieve the desired spacing and stability for your dataset.

![OrgChart Layout Manager Top-Bottom](Layout-Management_images/Layout-Management_img17.png)
