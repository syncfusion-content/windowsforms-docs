...
Closing of docked window can be restricted using `DockVisibilityChanging` event. When the end users tries to change the WinForms Docking Control visibility, this event will be handled. The members of this event is as follows.
