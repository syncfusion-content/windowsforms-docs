...
Closing of docked window can be restricted using `DockVisibilityChanging` event. When the end users tries to change the visibility of the internal control, this event will be handled. The members of this event is as follows.
