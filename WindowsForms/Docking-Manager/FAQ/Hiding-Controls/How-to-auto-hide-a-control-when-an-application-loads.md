---
layout: post
title: How to auto hide a control when an application loads in Docking Manager | Syncfusion®
...
# How to auto hide a control when an application loads in Docking Manager
