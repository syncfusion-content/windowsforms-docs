...
[SetAsMDIChild](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.DockingManager~SetAsMDIChild.html) function helps to set the docking window to the tabbed MDIChild window in DockingManager using [TabbedMDIManager](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.TabbedMDIManager.html) control. And also we can set the docked control as an MDI Child in an easy method, by using the `Tabbed document` option in the context menu. To Enable this option, attach the parent form of DockingManager to MDI container of TabbedMDIManager by using [AttachToMdiContainer](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.TabbedMDIManager~AttachToMdiContainer.html). 
...
[SetMDIChildIcon](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.DockingManager~SetMDIChildIcon.html) function helps to set the custom icons in caption bar of MDIChild window in DockingManager.
...
[SetAsMDIChild](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.DockingManager~SetAsMDIChild.html) function helps to change the size of MDI window in DockingManager.
...
MDI window can be moved to dock state by using its ContextMenu option. This can also be done programmatically by using the [SetAsMDIChild](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.DockingManager~SetAsMDIChild.html) function.
...
The MDI child forms can have Office2007 look and feel. It can be enabled through [Office2007MdiChildForm](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.DockingManager~Office2007MdiChildForm.html) property. 

### Change color scheme for Office 2007 style MDI window

Color schemes are also supported that can be specified by using [Office2007MdiColorScheme](https://help.syncfusion.com/cr/cref_files/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.DockingManager~Office2007MdiColorScheme.html) property.
