---
layout: post
title: Floating in Windows Forms Grid Control control | Syncfusion
description: Learn about Floating support in Syncfusion Windows Forms Grid Control control and more details.
