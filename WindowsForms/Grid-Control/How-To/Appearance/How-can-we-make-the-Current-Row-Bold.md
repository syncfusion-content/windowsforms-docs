---
layout: post
title: How to Bold Current Row in Windows Forms GridControl | Syncfusion®
description: Bold the current row in Syncfusion® Windows Forms GridControl using events to dynamically update row styles based on the active cell and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Bold Current Row in Windows Forms GridControl
