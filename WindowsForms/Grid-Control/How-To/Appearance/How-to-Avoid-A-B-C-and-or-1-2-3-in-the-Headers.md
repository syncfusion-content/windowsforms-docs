---
layout: post
title: How to Hide Header Labels in WinForms Grid Control | Syncfusion®
description: Hide A, B, C and 1, 2, 3 header labels in Syncfusion® Windows Forms Grid Control using row and column header settings and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Hide Header Labels in Windows Forms Grid Control
