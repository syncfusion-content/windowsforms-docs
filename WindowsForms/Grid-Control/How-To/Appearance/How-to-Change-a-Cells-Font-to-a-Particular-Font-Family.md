---
layout: post
title: How to Change a Cell Font in WinForms Grid Control | Syncfusion®
description: Change a cell FontFamily in Syncfusion® Windows Forms Grid Control using font properties and methods to customize cell appearance and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Change a Cell Font in Windows Forms Grid Control
