---
layout: post
title: How to Set a Row BackColor in Windows Forms GridControl | Syncfusion®
description: Change the BackColor of a single row in Syncfusion® Windows Forms GridControl using row style settings and customize its appearance and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Set a Row BackColor in Windows Forms GridControl
