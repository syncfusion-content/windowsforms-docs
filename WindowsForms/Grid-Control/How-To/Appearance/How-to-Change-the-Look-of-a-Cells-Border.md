---
layout: post
title: How to Customize CellBorder in Windows Forms GridControl | Syncfusion®
description: Change the look of a cell border in Syncfusion® Windows Forms GridControl using border styles, colors, weights, and margin settings and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Customize a Cell Border in Windows Forms GridControl
