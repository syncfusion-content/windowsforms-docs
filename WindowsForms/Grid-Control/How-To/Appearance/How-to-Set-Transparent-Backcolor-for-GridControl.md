---
layout: post
title: How to Set TransparentColor in Windows Forms GridControl | Syncfusion®
description: Set a transparent BackColor in Syncfusion® Windows Forms GridControl using background properties to create transparent grid backgrounds and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Set Transparent BackColor in Windows Forms GridControl
