---
layout: post
title: How to Set Grid BackColor in Windows Forms Grid Control | Syncfusion®
description: Set the background color for a grid in Syncfusion® Windows Forms Grid Control using grid properties to customize the grid appearance and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Set the BackColor for a Grid in Windows Forms Grid Control
