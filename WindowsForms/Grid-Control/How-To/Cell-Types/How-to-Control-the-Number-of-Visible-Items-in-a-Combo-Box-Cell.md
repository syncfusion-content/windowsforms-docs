---
layout: post
title: Control ComboBox Items in Windows Forms GridControl | Syncfusion®
description: Control the number of visible items in a combo box cell in Syncfusion® Windows Forms GridControl using the DropDownRows property and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Control Combo Box Items in Windows Forms GridControl
