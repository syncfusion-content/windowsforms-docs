---
layout: post
title: Create MultiSelect Dropdown in WinForms Grid Control | Syncfusion®
description: Create a multi-select dropdown grid in a cell in Syncfusion® Windows Forms Grid Control using a custom DropDownGrid cell type and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Create a Multi-Select Dropdown in Windows Forms Grid Control 
