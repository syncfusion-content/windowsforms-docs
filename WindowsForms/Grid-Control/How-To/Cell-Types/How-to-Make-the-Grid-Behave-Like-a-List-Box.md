...
description: Make the Grid behave like a list box in Syncfusion® Windows Forms GridControl using row selection and current cell activation settings and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Make Grid Behave Like a List Box in Windows Forms GridControl
