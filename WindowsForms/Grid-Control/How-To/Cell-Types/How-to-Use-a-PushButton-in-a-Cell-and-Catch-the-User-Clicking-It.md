---
layout: post
title: Use a PushButton in a Cell in Windows Forms GridControl | Syncfusion®
description: Use a PushButton in a cell in Syncfusion® Windows Forms GridControl and handle user click events to perform custom actions and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Use a PushButton in a Cell in Windows Forms GridControl
