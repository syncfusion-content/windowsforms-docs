...
description: Learn about Grid Model Options in Syncfusion® Windows Forms GridControl, including current cell behavior, scrolling, selection colors, borders, and more.
