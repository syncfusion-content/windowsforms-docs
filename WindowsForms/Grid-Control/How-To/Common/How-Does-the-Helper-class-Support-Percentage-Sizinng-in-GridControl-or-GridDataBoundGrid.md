...
description: Use a helper class for percentage sizing in Syncfusion® Windows Forms GridControl to automatically size columns based on proportional, percentage values.
