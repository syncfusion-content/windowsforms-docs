---
layout: post
title: Align an Image Button in Windows Forms GridControl | Syncfusion®
description: Align an image button at the center of a cell in Syncfusion® Windows Forms GridControl by customizing the cell model and renderer layout and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Align ImageButton in Center Cell in Windows Forms GridControl
