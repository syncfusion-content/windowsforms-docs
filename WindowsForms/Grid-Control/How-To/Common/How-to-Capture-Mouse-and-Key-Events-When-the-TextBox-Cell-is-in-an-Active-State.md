---
layout: post
title: Capture Mouse, Key Events in Windows Forms GridControl | Syncfusion®
description: Capture mouse and key events when a text box cell is in an active state in Syncfusion® Windows Forms GridControl using cell renderer events and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Capture Mouse and Key Events in Windows Forms GridControl
