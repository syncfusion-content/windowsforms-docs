---
layout: post
title: Get Cell Coordinates in Windows Forms GridControl | Syncfusion®
description: Get cell coordinates under a given point in Syncfusion® Windows Forms GridControl using PointToRowCol and retrieve row and column information and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Get Cell Coordinates in Windows Forms GridControl
