---
layout: post
title: Enable Overstrike Mode in Windows Forms GridControl | Syncfusion®
description: Enable overstrike mode in Syncfusion® Windows Forms GridControl to replace existing characters while typing instead of inserting new characters and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Enable Overstrike Mode in Windows Forms GridControl
