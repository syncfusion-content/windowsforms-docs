---
layout: post
title: Validate Grid Cell Changes in Windows Forms Grid Control | Syncfusion®
description: Validate changes made to grid cells in Syncfusion® Windows Forms Grid Control using validation events, compare old and new values, and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Validate Changes Made to Grid Cell in WinForms Grid Control
