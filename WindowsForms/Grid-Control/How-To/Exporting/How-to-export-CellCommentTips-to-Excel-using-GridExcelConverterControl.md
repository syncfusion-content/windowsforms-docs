---
layout: post
title: Export CellComment to Excel in Windows Forms GridControl | Syncfusion®
description: Export CellCommentTips to Excel in Syncfusion® Windows Forms GridControl using GridExcelConverterControl and the QueryImportExportCellInfo event and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Export CellCommentTips to Excel in Windows Forms GridControl
