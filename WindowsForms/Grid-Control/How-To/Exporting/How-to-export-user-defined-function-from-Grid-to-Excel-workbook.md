---
layout: post
title: Export User-Defined Functions to Excel in GridControl | Syncfusion®
description: Export user-defined functions from Syncfusion® Windows Forms GridControl to Excel workbooks using GridExcelConverterControl and custom Excel add-ins and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Export Custom Formulas to Excel in Windows Forms GridControl
