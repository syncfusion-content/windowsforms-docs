---
layout: post
title: Resize RowHeight Based Font in Windows Forms GridControl | Syncfusion®
description: Resize row height based on cell font and content in Syncfusion® Windows Forms GridControl using row resizing events and text measurement methods.
