---
layout: post
title: Set Column Width in Windows Forms Grid Control | Syncfusion®
description: Set the width of columns in Syncfusion® Windows Forms Grid Control using the ColWidths collection and customize column sizing programmatically.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Set the Width of a Column in Windows Forms Grid Control
