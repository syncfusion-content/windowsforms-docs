---
layout: post
title: AutoFit Rows and Columns in Windows Forms Grid Control | Syncfusion®
description: Automatically size column widths and row heights to fit text in Syncfusion® Windows Forms Grid Control using ResizeToFit methods and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to AutoFit Rows and Columns in Windows Forms Grid Control
