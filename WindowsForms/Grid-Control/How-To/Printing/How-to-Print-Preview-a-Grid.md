---
layout: post
title: Print Preview a Grid in Windows Forms Grid Control | Syncfusion®
description: Preview grid content before printing in Syncfusion® Windows Forms Grid Control using the GridPrintDocument class and PrintPreviewDialog.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Print Preview a Grid in Windows Forms Grid Control
