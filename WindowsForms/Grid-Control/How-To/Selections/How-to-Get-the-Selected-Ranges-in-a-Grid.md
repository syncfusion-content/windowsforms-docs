---
layout: post
title: Get Selected Ranges in Windows Forms Grid Control | Syncfusion®
description: Get selected ranges in Syncfusion® Windows Forms Grid Control using the Selections.Ranges collection and access active and expanded ranges and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Get Selected Ranges in Windows Forms Grid Control
