---
layout: post
title: Prevent Column Resizing in Windows Forms Grid Control | Syncfusion®
description: Prevent resizing of specific columns in Syncfusion® Windows Forms Grid Control by handling the ResizingColumns event and customizing resize behavior and more.
platform: windowsforms
control: Grid Control
documentation: ug
---

# How to Prevent Resizing a Specific Column in WinForms Grid Control
