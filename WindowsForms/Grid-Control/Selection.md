---
layout: post
title: Selection in Windows Forms Grid Control control | Syncfusion
description: Learn about Selection support in Syncfusion Windows Forms Grid Control control and more details.
