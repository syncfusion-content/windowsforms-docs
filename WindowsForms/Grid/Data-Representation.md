...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img48.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img49.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img51.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img53.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img54.jpeg)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img55.jpeg)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img56.jpeg)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img57.jpeg)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img58.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img59.jpeg)
...
4. Here is a sample output.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img60.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img61.png)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img63.png)



The following screen shot shows GroupDropArea postioned at the left of Grid Grouping control.

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img64.png)


_Figure 376: GroupDropArea aligned at the Left_

The following screen shot shows GroupDropArea postioned at the bottom of Grid Grouping control.

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img65.png)

The following screen shot shows GroupDropArea postioned at the right of Grid Grouping control.

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img66.png)



For more information on setting the alignment of GroupDropArea, see 

&lt;Installed Location&gt;\Syncfusion\EssentialStudio\<Version>\Windows\Grid.Grouping.Windows\Samples\Grouping\Grouping Demo.
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img67.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img68.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img69.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img70.jpeg)
...
5. Run the sample and group the table against any data column. Here is a sample screen shot that shows the grouped grid against 'Sport' column.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img71.png)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img73.png)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img74.png)

To view a sample on Freezing the Caption Row, see &lt;Installed Location&gt;\Syncfusion\EssentialStudio\&lt;Version&gt;\Windows\Grid.Grouping.Windows\Samples\Grouping\Grouping Demo
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img75.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img76.jpeg)
...
7. Run the application. The following output is generated.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img79.jpeg)
...
> Note: For more details, refer to the following browser sample: 
>
> &lt;Install Location&gt;\Syncfusion\EssentialStudio\[Version Number]\Windows\Grid.Grouping.Windows\Samples\Sorting\Sort By Display Member Demo
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img81.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img83.jpeg)
...
4. Run the sample. The grid will look like this.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img84.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img86.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img87.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img88.jpeg)
...
5. When you run the sample, your grid will look similar to this.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img90.jpeg)

Here is another screenshot that shows the grouping grid with Caption Summaries disabled.

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img91.jpeg)
...
3. Create SortColumnDescriptor for the field ShipCountry. Change default group order by using SetGroupSummaryOrder method with its parameters conveying summary name and property in the summary. Then group the grid against this column.
...
4. When you run the sample, you will see the groups sorted against summary values of Freight. Here is a sample screen shot.

   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img93.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img95.jpeg)
...
Me.gridGroupingControl1.TableDescriptor.ExpressionFields.AddRange(New Syncfusion.Grouping.ExpressionFieldDescriptor() {exp1, exp2})

{% endhighlight %}

The screen shot given below highlights these expression fields.

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img96.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img98.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img99.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img100.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img104.jpeg)



![](Grid-Grouping-Control_images/Grid-Grouping-Control_img105.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img106.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img107.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img109.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img111.png)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img112.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img114.png)





_Figure 410: Setting Up Relations by using GridRelationDescriptor Collection Editor_
...
<td>
RelationKind</td><td>
Specifies the type of the relation.The options included are as follows.
<ul>
<li>RelatedMasterDetails</li>
<li>ForeignKeyReference</li>
<li>ForeignKey KeyWords</li>
<li>UniformChildList</li>
<li>ListItemReference</li>
</ul></td></tr>
<tr>
<td>
<br\>AllowCacheChildList</td><td>
<ul>
<li>Indicates whether the ChildList associated with a view can be cached.</li>
<li>Used with UniformChildList relation.</li>
</ul>
<br\></td></tr>
<tr>
<td>
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img115.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img116.jpeg)
...
5. When you run the sample, you could find the tables connected with Master-Details relation.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img117.jpeg)
...
5. Here is a sample output that displays a look up child list for data column State with value Georgia.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img119.jpeg)
...
5. Here is a sample output.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img121.jpeg)


> Note: For more details, refer to the following browser sample:
>
> &lt;Install Location&gt;\Syncfusion\EssentialStudio\[Version Number]\Windows\Grid.Grouping.Windows\Samples\Relation And Hierarchy\Employee Territory Order Demo\
...
5. Here is a sample output that displays a look up child list for the data column Country with value Brazil.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img123.jpeg)
...
6. Here is a sample output.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img125.jpeg)
