...
For more details about the hiding columns and rows, refer the link over [here](http://help.syncfusion.com/windowsforms/grid/working-with-rows-and-columns).
...
N> You can refer the [FormatCellDialog](http://help.syncfusion.com/windowsforms/grid/appearance-and-formatting#formatcell-dialog) section for detailed information. 
...
N> For more information about `CoveredRanges`, see the link over [here](http://help.syncfusion.com/windowsforms/grid/covered-ranges).
...
For more details about the `Cell Merging`, refer the link over [here](http://help.syncfusion.com/windowsforms/grid/cell-merging).
...
For more information about this section, refer the link over [here](http://help.syncfusion.com/windowsforms/grid/floating).
...
For more information about the `Undo-Redo`, See [Undo - Redo](http://help.syncfusion.com/windowsforms/grid/undo-redo)
...
N> This section has been explained briefly in [Find and Replace](http://help.syncfusion.com/windowsforms/grid/find-and-replace) section.
