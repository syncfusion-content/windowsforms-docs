...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img22.jpeg)
...
3. Add a button and listbox to the main form. Clicking the button will create a grid grouping control and load it with Virtual List. ListBox serves as Log Window wherein you will display the log messages like time elapsed for loading the grid, list of optimizations applied, and so on. Your form will look like the one below at design time.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img25.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img26.jpeg)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img27.png)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img28.jpeg)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img29.png)
...

{
    ...
    public ManualTotalSummary(Group g, string field) : this(g, g.ParentTableDescriptor.Fields[field])
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img31.png)
...
7. Given below is a sample screen shot. While running the sample, apply grouping, sorting and filtering, and then check for the CPU time usage in TaskManager to detect grid performance.
   ...
   ![](Grid-Grouping-Control_images/Grid-Grouping-Control_img33.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img35.jpeg)
...
![](Grid-Grouping-Control_images/Grid-Grouping-Control_img36.jpeg)

![](Grid-Grouping-Control_images/Grid-Grouping-Control_img37.jpeg)

_Figure 357: Time Taken to Group the Records_
