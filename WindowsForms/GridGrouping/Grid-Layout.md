...
To know in detail with sample, refer the KB [article](https://support.syncfusion.com/kb/article/5601/how-to-set-the-scrollbar-when-the-freeze-columns-exceeds-the-client-area-in-winforms) which explains about this.
