...
The following list of assemblies should be added as reference to use the GroupBar in any application:
...
<td>
The Syncfusion.Shared.Base contains the class that handles all UI operations and contains helper class of GroupBar control.
</td>
</tr>
</table>
...
To use GroupBar control in Windows Forms application via nuget, the following packages should be installed.
