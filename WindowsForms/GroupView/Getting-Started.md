...
This section describes how to add `GroupView` control in a Windows Forms application and overview of its basic functionalities.

## Assembly deployment

The following list of assemblies should be added as reference to use the GroupView in any application:
