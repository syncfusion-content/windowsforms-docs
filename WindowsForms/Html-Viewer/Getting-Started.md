...
![Search HTML UI control in toolbox in WindowsForms](getting-started_images/windowsforms-html-viewer-search-html-ui-control-toolbox.png)

![Drag an drop the HTML UI  control in WindowsForms application](getting-started_images/windowsforms-html-viewer-drag-drop-html.png)

**Configure Title**

Title text can be set using `Title` property. The visibility of the title can be customized using `ShowTitle` property.

![Setting tile for html ui control](getting-started_images/windowsforms-html-viewer-setting-tile.png)
...
![HTMLUIControl added using code](getting-started_images/windowsforms-html-viewer-adding-code.png)
...
![Setting title for HTMLUIControl](getting-started_images/windowsforms-html-viewer-setting-title.png)
...
![HTMLUI control loads the given input file](getting-started_images/windowsforms-html-viewer-loading-html.png)
