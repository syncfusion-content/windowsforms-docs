...
string htmlCode="<html><head><title>A Tag support</title></head><body><A href="link.htm" aria-label="Link">Link</A></body></html>";
...
Private htmlCode As String = "<html><head><title>A Tag support</title></head><body><A href="link.htm" aria-label="Link">Link</A></body></html>"
