...
# MHT Formats in WinForms HTML Viewer
...
WinForms HTML Viewer supports the usage of the simple MHTML files. The WinForms HTML Viewer control allows the user to load the MHTML files from the user's drive with the help of the [LoadHTML](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.HTMLUI.HTMLUIControl.html#Syncfusion_Windows_Forms_HTMLUI_HTMLUIControl_LoadHTML_System_IO_Stream_) method.
