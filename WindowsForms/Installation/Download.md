...
The Syncfusion Windows Forms installer can be downloaded from the [Syncfusion.com](https://www.syncfusion.com/winforms-ui-controls) website. You can either download the licensed installer or try our trial installer depending on your license.
...
4. After downloading, the Syncfusion Windows Forms trial installer can be unlocked using either the trial unlock key or the Syncfusion registered login credential. More information on generating an unlock key can be found in [this](https://www.syncfusion.com/kb/8069/how-to-generate-unlock-key-for-essentials-studio-products) article.
...
You can also refer to the [**Online installer**](https://help.syncfusion.com/windowsforms/installation-and-upgrade/install-using-the-web-installer) and [**Offline installer**](https://help.syncfusion.com/windowsforms/installation-and-upgrade/install-using-the-offline-installer) links for step-by-step installation guidelines.	
