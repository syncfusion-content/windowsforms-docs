...
* [Prerequisites](https://help.syncfusion.com/windowsforms/installation/installation-errors#prerequisites)
...
After renewing, refer to the [license key generation instructions](https://help.syncfusion.com/windowsforms/licensing/how-to-generate) to apply the renewed key.
...
For installation steps, see the [web installer](https://help.syncfusion.com/windowsforms/installation/web-installer/how-to-install) or [offline installer](https://help.syncfusion.com/windowsforms/installation/offline-installer/how-to-install) guide.
