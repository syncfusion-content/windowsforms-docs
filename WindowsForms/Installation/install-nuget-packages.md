...
**NuGet** is a Package management system for Visual Studio. It makes it easy to add, update and remove external libraries in our application. Syncfusion publishing all Winforms  NuGet packages in [nuget.org](https://www.nuget.org/packages?q=Tags%3A%22AspNet.Core%20EJ2%22+syncfusion). The Syncfusion Winforms NuGet packages can be used without installing the Syncfusion installation. You can simply exploit the Syncfusion Winforms NuGet packages in Winfows Forms application to develop with the Syncfusion Winforms components.
...
The **Package Manager Console** saves NuGet packages installation time since you don't have to search for the Syncfusion Winforms NuGet package which you want to install, and you can just type the installation command to install the appropriate Syncfusion Winforms NuGet package. Follow the instructions below to use the Package Manager Console to reference the Syncfusion Winforms component as NuGet packages in your Winforms web application.
...
2. The **Package Manager Console** will be shown at the bottom of the screen. You can install the Syncfusion Winforms NuGet packages by enter the following NuGet installation commands.
    ...
    ***Install specified Syncfusion Winforms NuGet package.***
    ...
    The below command will install the Syncfusion Winforms NuGet package in the default ASP.NET Core application.
    ...
    ***Install specified Syncfusion Winforms NuGet package in specified Winforms application***
    ...
    The below command will install the Syncfusion Winforms NuGet package in the given ASP.NET Core application.
