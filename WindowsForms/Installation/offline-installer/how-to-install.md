...
* The Windows Forms platform requires .NET Framework 4.5 or later on the target machine.
...
2. To unlock the Syncfusion offline installer, you have two options:
    ...
    **Use Unlock Key**
    ...
    Unlock keys are used to unlock the Syncfusion offline installer, and they are product- and version-specific. You should use either a Syncfusion licensed or trial unlock key to unlock the Syncfusion Windows Forms installer.
...
7. Click the **Finish** button. Your system has now been installed with the Syncfusion Essential Studio Windows Forms product.
...
3. Run `%temp%`. The Temp folder will open. The `syncfusionessentialwindowsforms_{version}.exe` file will be located in one of the folders.
