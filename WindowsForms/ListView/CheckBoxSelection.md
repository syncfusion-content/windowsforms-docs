---
layout: post
title: CheckBox Selection Mode in Windows Forms ListView | Syncfusion®
description: CheckBox selection mode in Windows Forms ListView enables users to select items using check boxes, supporting efficient multi-item selection and management.
platform: windowsforms
control: ListView
documentation: ug
---

# CheckBox Selection Mode in Windows Forms ListView

The Windows Forms ListView supports loading the checkBox to each item that allows the user to check or uncheck the corresponding item. You can display the check box in each item by setting the [ShowCheckBoxes](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_ShowCheckBoxes) property to true.
...
The check box provides support to select in the context of state of the check box based on the [CheckBoxSelectionMode](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_CheckBoxSelectionMode) property.                                                                        

ListView has the following modes for selection based on the check box state.

* Default: don’t want to affect the selection while checking/unchecking the item CheckBox, you need to set `CheckBoxSelectionMode` property value as Default.
...
* SelectOnCheck: To select/deselect the items by using the CheckBox alone, set the [CheckBoxSelectionMode](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_CheckBoxSelectionMode) as SelectOnCheck. 
...
* SynchronizeSelection: To synchronize the selection with IsChecked state, set the [CheckBoxSelectionMode](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_CheckBoxSelectionMode) as SynchronizeSelection. In this mode, you can select an item by checking the check box or select/deselect the item will check/uncheck the corresponding item checkbox.
...
* CheckOnItemClick: To check or uncheck the item check box state by clicking the item, set the [CheckBoxSelectionMode](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_CheckBoxSelectionMode) as CheckOnItemClick.
...
## TriState mode
The ListView allows you to enable or disable the indeterminate state for item check box by using the [AllowTriStateMode](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_AllowTriStateMode) property. The tristate mode can only be supported in the data bound mode i.e. the [CheckedMember](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_CheckedMember) property must have the underlying datasource property in type of `CheckState`.
...
The ListView gets all the checked items through the [CheckedItems](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_CheckedItems) property. 
...
The ListView allows all the items to change the checked state by checking the `SelectAll` item. You can enable select all item by setting the [AllowSelectAll](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_AllowSelectAll) and [ShowCheckBoxes](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_ShowCheckBoxes) properties to true.
...
## Recursive checking
The ListView provides support for recursive checking where the checked state of the group header item and group item are changed recursively based on the state of currently changed item.
...
You can enable recursive checking by setting [AllowRecursiveChecking](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_AllowRecursiveChecking) property and [ShowCheckBoxes](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_ShowCheckBoxes) property as true.
...
## Appearance
The ListView allows the item check box customization by using the `CheckBoxStyle` property.
...
## Conditional styling
The ListView allows the item check box customization by using [DrawCheckBox](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_DrawCheckBox) event.
...
You can cancel the checking process within this event by setting the [Cancel](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.Events.ItemCheckingEventArgs.html) property to true.
...
### ItemChecked event
The [ItemChecked](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.ListView.SfListView.html#Syncfusion_WinForms_ListView_SfListView_ItemChecked) event will occur once checking process is completed for the checked item in the ListView by using ItemChecked event.
