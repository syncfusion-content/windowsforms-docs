...
# About Syncfusion® Windows Forms MessageBox Control
...
* **Details view** - Helps to view the detailed message about the text shown in the MessageBox.
...
* **Visual Styles** - Provides rich set of VisualStyle to customize the look and feel of MessageBox.
