---
layout: post
title: Working with Interaction Modes in Windows Forms PDF Viewer control | Syncfusion
...
# Working with Interaction Modes in Windows Forms PDF Viewer (PdfViewerControl)
