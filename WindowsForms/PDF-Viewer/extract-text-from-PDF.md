---
layout: post
title: Extract Text from PDF Files in Windows Forms PDF Viewer control | Syncfusion
...
# Extract Text from PDF Files in Windows Forms PDF Viewer (PdfViewerControl)
