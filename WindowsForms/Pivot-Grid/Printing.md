...
WinForms Pivot Grid provides support for printing that allows users to print the contents of the control on paper and it also provides support to preview the contents before printing. This support is used to print the control in both landscape and portrait views.
