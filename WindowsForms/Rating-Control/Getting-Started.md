---
layout: post
title: Getting Started with WinForms Rating control | Syncfusion
description: This section explains about the getting started with Syncfusion Windows Forms Rating Control and more details.
