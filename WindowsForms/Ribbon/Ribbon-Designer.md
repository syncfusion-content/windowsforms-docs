---
layout: post
title: Ribbon Designer in Windows Forms Ribbon | Syncfusion®
description: The Ribbon Designer in Ribbon is a visual designer to add custom tabs, controls, and groups without running the application.
platform: windowsforms
control: RibbonControlAdv 
documentation: ug
---

# Ribbon Designer in WinForms Ribbon Control

Ribbon designer is the visual designer for the WinForms Ribbon Control. It is used to add custom tabs, control and groups to the Ribbon without running the application.
...
**Image Scaling:** Images used inside WinForms Ribbon Control have been scaled internally for different screen resolution. The following defined image size has been used for the different item sizes.
...
**WinForms Ribbon Control Height:** WinForms Ribbon Control height is defined internally to accommodate the items and maintain in three rows with standard height in scaling.
