...
![Windows form datagrid showing control is dragged from toolbox](GettingStarted_images/GettingStarted_img1.png)
...
![Windows form datagrid showing collections of data](GettingStarted_images/GettingStarted_img2.png)
...
{% endhighlight %}
{% endtabs %}
![Windows form datagrid showing selected single row or multiple rows](GettingStarted_images/GettingStarted_img3.png)
...
{% endhighlight %}
{% endtabs %}
![Windows form datagrid showing sorting the columns](GettingStarted_images/GettingStarted_img4.png)
...
{% endhighlight %}
{% endtabs %}
![Windows form datagrid showing grouping area over the column headers](GettingStarted_images/GettingStarted_img5.png)
...
{% endhighlight %}
{% endtabs %}
![Windows form datagrid showing filtering the rows](GettingStarted_images/GettingStarted_img6.png)
