---
layout: post
title: Axes in Windows Forms Smith Chart control | Syncfusion<sup>®</sup>
description: Learn about Axes support in Syncfusion<sup>®</sup> Windows Forms Smith Chart (SfSmithChart) control and more details.
