---
layout: post
title: Series in Windows Forms Smith Chart control | Syncfusion<sup>®</sup>
description: Learn about Series support in Syncfusion<sup>®</sup> Windows Forms Smith Chart (SfSmithChart) control and more details.
