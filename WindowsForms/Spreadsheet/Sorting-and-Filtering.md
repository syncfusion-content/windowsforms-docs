...
By default, Filtering support will not be enabled in the Spreadsheet, hence if you want to enable the Filtering in Spreadsheet, set the `AllowFiltering` property of the `Spreadsheet` to be true.
