...
![Intellisense to choose items in WindowsForms Syntax Editor](intellisense-images/windowsforms-syntax-editor-intellisense.png)
...
![Autocomplete items filtered based on types character in WindowsForms Syntax Editor](intellisense-images/windowsforms-syntax-editor-autocomplete-items-filtered-based-on-types-character.png)
...
![Forecolor of items in context choice customized in WindowsForms Syntax Editor](intellisense-images/windowsforms-syntax-editor-forecolor-of-items-in-context-choice-customized.png)
...
![Font of items in context choice customized in WindowsForms Syntax Editor](intellisense-images/windowsforms-syntax-editor-font-of-items-in-context-choice-customized.png)
...
![Context choice to display different messages in WindowsForms Syntax Editor](intellisense-images/windowsforms-syntax-editor-contaxt choice-to-display-different-messages.png)
...
![Gradient back color context prompt in WindowsForms Syntax Editor](intellisense-images/windowsforms-syntax-editor-gradient-back-color-context-prompt.png)
...
![Tooltip for text in WindowsForms Syntax Editor](intellisense-images/windowsforms-syntax-tooltip-for-text.png)
...
![Tooltip border color customized in WindosForms Syntax Editor](intellisense-images/windowsforms-syntax-editor-tooltip-border-color-customized.png)
...
![WindowsForms Syntax Editor autocomplete the typed text based on items added in context choice](intellisense-images/windowsforms-syntax-editor-autocomplete.png)
