...
<tr>
<td>
{{ '[MoveUp](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveUp)' | markdownify }}</td><td>
Moves cursor up, if possible.</td></tr>
<tr>
<td>
{{ '[MoveDown](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveDown)' | markdownify }}</td><td>
Moves cursor down, if possible.</td></tr>
<tr>
<td>
{{ '[MoveLeft](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveLeft)' | markdownify }}
</td><td>
Moves cursor left, if possible.</td></tr>
<tr>
<td>
{{ '[MoveRight](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveRight)' | markdownify }}</td><td>
...
<tr>
<td>
{{ '[MoveLeftWord](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveLeftWord)' | markdownify }}</td><td>
Moves caret to the left by one word.</td></tr>
<tr>
<td>
{{ '[MoveRightWord](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveRightWord)' | markdownify }}</td><td>
...
<tr>
<td>
{{ '[MoveToLineStart](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveToLineStart)' | markdownify }}</td><td>
Moves caret to the beginning of the line. First whitespace will be skipped.</td></tr>
<tr>
<td>
{{ '[MoveToLineEnd](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveToLineEnd)' | markdownify }}</td><td>
...
<tr>
<td>
{{ '[MovePageUp](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MovePageUp)' | markdownify }}</td><td>
Moves caret one page up.</td></tr>
<tr>
<td>
{{ '[MovePageDown](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MovePageDown)' | markdownify }}</td><td>
...
Position the keyboard cursor at the beginning and end of the indentation block by using the [JumpToIndentBlockStart](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_JumpToIndentBlockStart) and [JumpToIndentBlockEnd](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_JumpToIndentBlockEnd) functions respectively.
...
<tr>
<td>
{{ '[MoveToBeginning](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveToBeginning)' | markdownify }}</td><td>
Moves caret to the beginning of the file.</td></tr>
<tr>
<td>
{{ '[MoveToEnd](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_MoveToEnd)' | markdownify }}</td><td>
...
<tr>
<td>
{{ '[ShowVerticalScroller](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_ShowVerticalScroller)' | markdownify }}</td><td>
Specifies a value indicating whether the vertical scroller can be shown or not.</td></tr>
<tr>
<td>
{{ '[ShowHorizontalScroller](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_ShowHorizontalScroller)' | markdownify }}</td><td>
Specifies a value indicating whether the horizontal scroller can be shown or not.</td></tr>
<tr>
<td>
{{ '[AlwaysShowScrollers](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_AlwaysShowScrollers)' | markdownify }}</td><td>
...
<tr>
<td>
{{ '[ScrollOffsetLeft](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_ScrollOffsetLeft)' | markdownify }}</td><td>
Specifies the left scroll offset.</td></tr>
<tr>
<td>
{{ '[ScrollOffsetRight](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_ScrollOffsetRight)' | markdownify }}</td><td>
Specifies the right scroll offset.</td></tr>
<tr>
<td>
{{ '[ScrollOffsetTop](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Edit.EditControl.html#Syncfusion_Windows_Forms_Edit_EditControl_ScrollOffsetTop)' | markdownify }}</td><td>
