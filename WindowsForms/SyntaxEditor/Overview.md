...
* **Word Wrap** - Provides extensive text wrapping support in EditControl. 
* **Line Number Support** - Provides a Line Numbers support as like in Visual Studio Editor. It can be automatically assigned to the contents of the EditControl for easy reference.
