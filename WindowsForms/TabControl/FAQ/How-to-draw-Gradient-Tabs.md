---
layout: post
title: How to draw Gradient Tabs in Windows Forms TabControlAdv | Syncfusion®
...
# How to draw Gradient Tabs in Windows Forms TabControlAdv

You can handle the DrawItem Event of [TabPageAdv](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Tools.TabPageAdv.html) and then set the gradient by using the [LinearGradientBrush](https://learn.microsoft.com/en-us/dotnet/api/system.windows.media.lineargradientbrush?view=netframework-4.7.2).
