---
layout: post
title: How to Highlight TabPage Text in TabControl | Syncfusion®
description: Learn how to highlight the TabPage text when the mouse hovers in Syncfusion Windows Forms TabControl control, its elements and more details.
platform: windowsforms
control: TabsPackage
documentation: ug
---

# How to Highlight TabPage Text in TabControl
