...
# Tab Navigation in WinForms TabControl
...
* Close - This button is used to close the WinForms TabControl. It can be set to appear for the whole control or individual tab pages. 
...
The [TabPrimitives](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Tools.TabPrimitivesCollection.html) can be added to the [WinForms TabControl](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Windows.Forms.Tools.TabControlAdv.html) by using either of the following ways,
