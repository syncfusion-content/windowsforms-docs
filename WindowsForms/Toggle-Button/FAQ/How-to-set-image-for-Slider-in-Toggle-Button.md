---
layout: post
title: How to Set Image for Slider in ToggleButton | Syncfusion®
description: Learn how to set an image for the Slider in Syncfusion Windows Forms ToggleButton control, its elements and more details.
