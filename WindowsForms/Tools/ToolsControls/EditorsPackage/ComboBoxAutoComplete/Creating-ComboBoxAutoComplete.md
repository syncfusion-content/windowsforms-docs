...
4. Set AutoCompleteSource to CustomSource as shown below. See[Source for AutoComplete Control](/windowsforms/Tools/EditorsPackage/AutoComplete-Controls/DataSource.html#source-for-autocomplete-control) to know the different AutoComplete sources.
