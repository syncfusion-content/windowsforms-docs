...
> Note: ComboBoxAdv can also be bound to an external Data source like Data Table. Refer_ [Databinding](http://docs.syncfusion.com/windowsforms/tools/editorspackage/comboboxcontols#data-binding ) _topic. To set image for dropdown items refer_ [Image settings](http://docs.syncfusion.com/windowsforms/tools/editorspackage/editorscontrols#integertextbox )_._
