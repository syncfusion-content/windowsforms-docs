---
layout: post
title: TreeMap Layout in Windows Forms TreeMap control | Syncfusion<sup>®</sup>
description: Learn about TreeMap Layout support in Syncfusion<sup>®</sup> Windows Forms TreeMap control, its elements and more details.
