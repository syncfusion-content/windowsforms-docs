...
N> Syncfusion Extension are published in Visual Studio Marketplace. You can download WinForms Extensions from [here](https://marketplace.visualstudio.com/items?itemName=SyncfusionInc.Windows-Extensions).
