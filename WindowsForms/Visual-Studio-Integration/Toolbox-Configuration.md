...
Syncfusion controls will be automatically configured in Visual Studio toolbox while installing the Syncfusion Windows Forms installer, if <b>“Configure Syncfusion Controls in Visual Studio”</b> checkbox selected from installer UI.
