...
* In the [BeforeNext](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.WizardControl~BeforeNext_EV.html) event handler, implement the below code, which will control the page sequence with the wizard control.
...
Page sequencing may also be controlled in the [NextClick](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.WizardControlPage~NextClick_EV.html) and [BackClick](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.WizardControlPage~BackClick_EV.html) events of Wizard Control Page.
...
* In the [NextClick](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.WizardControlPage~NextClick_EV.html) event handler, you implement this code:
...
* In the [BackClick](https://help.syncfusion.com/cr/windowsforms/Syncfusion.Tools.Windows~Syncfusion.Windows.Forms.Tools.WizardControlPage~BackClick_EV.html) event handler, implement this code.
