...
N>
* [DisplayShadow](https://help.syncfusion.com/windowsforms/chart/chart-series#hittestradius), [PhongAlpha](https://help.syncfusion.com/windowsforms/chart/chart-series#stepiteminverted) are used only in the customization options for `Bar chart`.
