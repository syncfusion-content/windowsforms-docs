...
N> Syncfusion Windows Forms Controls supports `.NET Framework 3.5` and later versions. The controls start with `syn` supports `.NET Framework 4.0` and later versions.
