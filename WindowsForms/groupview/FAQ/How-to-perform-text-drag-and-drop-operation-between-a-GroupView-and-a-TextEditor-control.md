...
description: Learn how to perform text drag-and-drop operations between GroupView and TextEditor controls in Windows Forms applications.
platform: windowsforms
control: GroupView
documentation: ug
---
# How to Drag and Drop Text Between GroupView and TextEditor

You could perform text drag-and-drop operation between a TextEditor control like RichTextBox and GroupView by handling the GroupView's [DragEnter](https://learn.microsoft.com/en-us/dotnet/api/system.windows.forms.control.dragenter?redirectedfrom=MSDN&view=netframework-4.7.2) and [DragLeave](https://learn.microsoft.com/en-us/dotnet/api/system.windows.forms.control.dragleave?redirectedfrom=MSDN&view=netframework-4.7.2) events as shown below.
