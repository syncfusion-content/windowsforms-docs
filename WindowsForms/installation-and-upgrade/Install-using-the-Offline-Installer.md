...
2. Double-click the Syncfusion Windows Forms platform Setup file. The Setup Wizard opens and extracts the package automatically.

   ![](Platform_images/Step-by-Step-Installation_img1.png)

   N> The Setup wizard extracts the syncfusionessentialwindowsforms_(version).exe dialog, displaying the unzip operation of the package.
...
1. When you do not have the extracted setup (syncfusionessentialwindowsforms_(version).exe) then follow the steps from 2 to 7.
...
7. Open the Command Prompt in administrator mode and pass the following arguments.
   ...
   **Arguments:** “Copied setup file path\syncfusionessentialwindowsforms_(version).exe” /uninstall silent 
