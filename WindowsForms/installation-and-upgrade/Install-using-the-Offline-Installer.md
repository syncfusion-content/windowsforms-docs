...
7.	Click Proceed.
	...
	N> The Completed screen is displayed once the Windows Forms platform is installed. If any version is selected to uninstall, The completed screen will display both install and uninstall status.
...
9. Click Finish. Syncfusion Windows Forms platform is installed in your system.
