---
layout: post
title: Installation and Deployment process for Syncfusion ES Windows products
description: This section provides information regarding learn how to install and deploy the Syncfusion Essential Studio Windows Forms components             
...
1.  Double-click the Syncfusion Essential Studio Platform Online Installer installer file. The installer Wizard opens and extracts the package automatically.

    ![Installer Extraction Wizard](WebInstaller/Step-by-Step-Installation_img1.png)

    
    N> The installer wizard extracts the syncfusionwindowsformswebinstaller_{version}.exe dialog, displaying the unzip operation of the package.
