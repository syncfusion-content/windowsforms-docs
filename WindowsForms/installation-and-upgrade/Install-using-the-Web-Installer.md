...
The following procedure illustrates how to install Essential Studio for Windows Forms Online Installer.

1.  Double-click the Syncfusion Windows Forms Online Installer setup file. The Setup Wizard opens and extracts the package automatically.

    ![](WebInstaller/Step-by-Step-Installation_img1.png)

    
    N> The Setup wizard extracts the syncfusionwindowsformswebinstaller_{version}.exe dialog, displaying the unzip operation of the package.
