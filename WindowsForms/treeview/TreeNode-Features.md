...
# TreeNode Features in WinForms TreeView (TreeViewAdv)

This section discusses the following topics.

## Primitives

WinForms TreeViewAdv control supports a set of primitive collections, that can be set through the Primitives Collection Editor available with each node in the TreeViewAdv controls. 
...
WinForms TreeViewAdv control can be customized with images for each of its actions for example collapse / expand state, plus / minus of the tree etc., This section discusses about the below topics.
